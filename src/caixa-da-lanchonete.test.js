...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['dinheiro','R$ 62,27',['salgado,3','combo1,2','suco,4']],
    ...
    test.each([
        ...
        ['dinheiro', 'R$ 159,60', ['cafe,7', 'sanduiche,18', 'queijo,15']],
        ['credito', 'R$ 170,98', ['cafe,20', 'sanduiche,16', 'queijo,1']],
    ...
    test.each([
        ...
        ['com forma de pagamento inválida', 'pix', 'Forma de pagamento inválida!', ['combo2, 2']],
        ['com forma de pagamento inválida', 'cheque', 'Forma de pagamento inválida!', ['combo1, 4']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
    ...
    test.each([
        ...
        ['queijo', 'credito', 'Item extra não pode ser pedido sem o principal', ['queijo,1','combo1,2']],
        ['chantily', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['queijo,1','combo2,1']],
    ...
    test.each([
        ['dinheiro','R$ 73,24',['cafe,1','suco,3','salgado,4','combo1,2','combo2,1']],
        ['credito', 'R$ 32,96',['cafe,1','chantily,1','sanduiche,1','queijo,1','combo1,2']],
        ['debito', 'R$ 154,50',['sanduiche,1', 'queijo,1','salgado,4','combo1,6','combo2,8']],    
    ])('compra de 5 itens em %p deve resultar em %p', validaTeste);    
